"use strict";
var invocation_list_1 = require('invocation-list');
var Life;
(function (Life) {
    /**
     @example
     ...
     */
    Life.willReceiveProps = invocation_list_1.invokedBy('componentWillReceiveProps', 1);
    /**
     @example
     ...
     */
    Life.didMount = invocation_list_1.invokedBy('componentDidMount', 0);
    /**
     @example
     ...
     */
    Life.willMount = invocation_list_1.invokedBy('componentWillMount', 0);
    /**
     @example
     ...
     */
    Life.shouldUpdate = invocation_list_1.invokedBy('componentShouldUpdate', 2);
    /**
     @example
     ...
     */
    Life.willUpdate = invocation_list_1.invokedBy('componentWillUpdate', 2);
    /**
     @example
     ...
     */
    Life.didUpdate = invocation_list_1.invokedBy('componentDidUpdate', 2);
    /**
     @example
     ...
     */
    Life.willUnmount = invocation_list_1.invokedBy('componentWillUnmount', 0);
