export declare module Life {
     ...
     */
    const willReceiveProps: (target: any, property: string | symbol) => void;
    /**
     @example
     ...
     */
    const didMount: (target: any, property: string | symbol) => void;
    /**
     @example
     ...
     */
    const willMount: (target: any, property: string | symbol) => void;
    /**
     @example
     ...
     */
    const shouldUpdate: (target: any, property: string | symbol) => void;
    /**
     @example
     ...
     */
    const willUpdate: (target: any, property: string | symbol) => void;
    /**
     @example
     ...
     */
    const didUpdate: (target: any, property: string | symbol) => void;
    /**
     @example
     ...
     */
    const willUnmount: (target: any, property: string | symbol) => void;
}
